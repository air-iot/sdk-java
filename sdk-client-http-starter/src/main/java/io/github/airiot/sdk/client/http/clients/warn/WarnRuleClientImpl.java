 ...
 */
@HttpExchange
public interface WarnRuleClientImpl extends WarnRuleClient {
    
    @GetExchange("/warning/rule")
    @Override
    ResponseDTO<List<Rule>> query(@Nonnull @GetObjectParams("query") Query query);
}
