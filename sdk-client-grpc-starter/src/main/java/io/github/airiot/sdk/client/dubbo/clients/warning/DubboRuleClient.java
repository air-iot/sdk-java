...
import io.github.airiot.sdk.client.service.warning.RuleClient;
...
public class DubboRuleClient implements RuleClient {
    ...
    @Override
    public ResponseDTO<List<Rule>> query(@Nonnull Query query) {
        ...
        Response response = this.ruleService.query(
