...
package io.github.airiot.sdk.client.dubbo.configuration.properties;
 ...
 * 客户端配置
 */
@ConfigurationProperties(prefix = DubboClientProperties.PREFIX)
public class DubboClientProperties implements InitializingBean {

    public static final String PREFIX = "airiot.client.dubbo";
