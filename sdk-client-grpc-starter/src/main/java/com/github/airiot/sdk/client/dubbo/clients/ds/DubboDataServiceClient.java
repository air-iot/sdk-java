package com.github.airiot.sdk.client.dubbo.clients.ds;
...
import com.github.airiot.sdk.client.dubbo.grpc.datasource.Request;
import com.github.airiot.sdk.client.dubbo.utils.DubboClientUtils;
import com.github.airiot.sdk.client.service.ds.DataServiceClient;
...
public class DubboDataServiceClient implements DataServiceClient {
    ...
    public <T> Response<T> call(@Nonnull Class<T> tClass, @Nonnull String dsId, @Nullable Map<String, Object> params) {
        ...
        com.github.airiot.sdk.client.dubbo.grpc.api.Response response = this.dataService.proxy(builder.build());
