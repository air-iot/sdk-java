...
public class TokenTests {
    ...
    public static class EmbedClass {
        ...
        public Response<Token> getToken1() {
            return this.getToken2();
        }

        public Response<Token> getToken2() {
            return this.getToken3();
        }

        public Response<Token> getToken3() {
    ...
    @Test
    void getTokenEmbed() {
        Response<Token> response = this.embed.getToken1();
        Assertions.assertTrue(response.isSuccess(), response.getFullMessage());
        Assertions.assertNotNull(response.getData(), "未查询到 token 信息");
    }
}
