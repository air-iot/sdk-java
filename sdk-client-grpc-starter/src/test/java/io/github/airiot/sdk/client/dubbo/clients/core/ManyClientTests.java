...
public class ManyClientTests {
    ...
    void queryDepartmentAndTable() {
        ResponseDTO<List<WorkTableDataClientTests.Employee>> employees = this.tableDataClient.query(WorkTableDataClientTests.Employee.class, "employee", Query.newBuilder()
                .select(WorkTableDataClientTests.Employee.class)
                .build());
        ResponseDTO<List<Project>> projects = this.projectClient.queryAll();
