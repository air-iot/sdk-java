...
public interface MediaLibraryClient {
     ...
     * @return 创建目录请求结果
     */
    default ResponseDTO<Void> mkdir(String catalog) {
     ...
     * @return 创建目录请求结果
     */
    ResponseDTO<Void> mkdir(MkdirDTO dir);
     ...
     */
    ResponseDTO<UploadFileResult> upload(String catalog, String action, String filename, byte[] fileData);
     ...
     */
    default ResponseDTO<UploadFileResult> upload(String catalog, String action, File file) throws IOException {
