...
public class FilterBuilder {
    ...
    public FilterBuilder(Query.Builder builder, Map<String, Object> filters) {
    ...
    public FilterBuilder regex(String field, String regex) {
        ...
        this.filters.put(field.trim(), LogicOp.REGEX.apply(regex));
    ...
    public FilterBuilder lt(String field, Object value) {
        ...
        Object filter = this.filters.get(field);
        if (!(filter instanceof Map)) {
            this.filters.put(field, LogicOp.LT.apply(value));
            return this;
        }

        Map<String, Object> map = new HashMap<>((Map<String, Object>) filter);
        map.putAll((Map<String, ?>) LogicOp.LT.apply(value));
        this.filters.put(field, map);
        return this;
    }
    ...
    public FilterBuilder lte(String field, Object value) {
        ...
        Object filter = this.filters.get(field);
        if (!(filter instanceof Map)) {
            this.filters.put(field, LogicOp.LTE.apply(value));
            return this;
        }
    ...
    public FilterBuilder gt(String field, Object value) {
        ...
        Object filter = this.filters.get(field);
        if (!(filter instanceof Map)) {
            this.filters.put(field, LogicOp.GT.apply(value));
            return this;
        }
    ...
    public FilterBuilder gte(String field, Object value) {
        ...
        Object filter = this.filters.get(field);
        if (!(filter instanceof Map)) {
            this.filters.put(field, LogicOp.GTE.apply(value));
            return this;
        }
