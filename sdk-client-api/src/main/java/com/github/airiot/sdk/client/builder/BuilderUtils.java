    ...
    public static <T> List<String> getColumns(Class<T> tClass) {
        ...
        return CLASS_COLUMNS.computeIfAbsent(tClass, tc -> {
            ...
            for (Field field : fields) {
                ...
                if (field.isAnnotationPresent(com.github.airiot.sdk.client.annotation.Field.class)) {
                    columns.add(
                            field.getAnnotation(com.github.airiot.sdk.client.annotation.Field.class).value()
                    );
                    continue;
                }
    ...
    static class LambdaCache {
        ...
        private String extractPropertyName(String method) {
            ...
            try {
                ...
                if (field.isAnnotationPresent(com.github.airiot.sdk.client.annotation.Field.class)) {
                    return field.getAnnotation(com.github.airiot.sdk.client.annotation.Field.class).value();
                }
