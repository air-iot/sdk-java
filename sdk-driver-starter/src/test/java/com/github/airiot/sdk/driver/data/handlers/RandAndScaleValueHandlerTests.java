...
public class RandAndScaleValueHandlerTests {
    ...
    void testSupports() {
        ...
        Assertions.assertFalse(handler.supports("device-001", "dataPoint-1", new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, null, null), 123));
        Assertions.assertTrue(handler.supports("device-001", "dataPoint-1", new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, null, 0d), 123));
        Assertions.assertTrue(handler.supports("device-001", "dataPoint-1", new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, 0, null), 123));
        Assertions.assertTrue(handler.supports("device-001", "dataPoint-1", new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, 0, 0d), 123));
    }

    @Test
    void testScaleValue() {
        com.github.airiot.sdk.driver.model.Tag tag = new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, null, 10d);
    ...
    @Test
    void testFixedValue() {
        com.github.airiot.sdk.driver.model.Tag tag = new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, 1, null);
    ...
    void testScaleAndRound() {
        com.github.airiot.sdk.driver.model.Tag tag = new com.github.airiot.sdk.driver.model.Tag("tag01", "tag01", null, null, 2, 0.1);
    ...
    @Test
    void test01() {
        com.github.airiot.sdk.driver.model.Tag tag = new Tag("tag01", "tag01", null, null, 2, 0.1);
